...
2.  **Console Pane**: The Console Pane (bottom-left) is where you
...
3.  **Environment and History Pane**: The Environment and History Pane
...
4.  **Plots and Help Pane**: The Plots and Help Pane (bottom-right)
...
Using RStudio projects makes this convenient and ensures that your working
directory is set properly. If for some reason your working directory is not what it
